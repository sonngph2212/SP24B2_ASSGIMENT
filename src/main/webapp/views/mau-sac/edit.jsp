...
<div class="container mt-5">
    <form id="myForm" method="POST" action="/app_war_exploded/mau-sac/update?id=${item.id}">
        <div class="mb-3">
            <label class="form-label">Mã</label>
            <input type="text" class="form-control" name="ma" value="${item.ma}">
            <% if (maErr != null) { %>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="ten" value="${item.ten}">
            <% if (tenErr != null) { %>
