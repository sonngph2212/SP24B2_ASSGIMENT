...
<div class="container mt-5">
    ...
    <a class="btn btn-success nb-2" href="/app_war_exploded/san-pham/create">Create</a>
    <div class="mb-2">
    ...
    <table class="table">
        ...
        <c:forEach items="${ dataList }" var="el" varStatus="status">
            <tr>
                ...
                <td>${ el.trangThai }</td>
                <td>
                    <a class="btn btn-primary" href="/app_war_exploded/san-pham/edit?id=${el.id}">Update</a>
                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"
                       href="/app_war_exploded/san-pham/delete?id=${el.id}">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
